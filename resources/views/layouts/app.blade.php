...
<head>
    ...
    <title>@yield('title', 'LMS') — Davao City Library</title>
    ...
    <aside class="sidebar">
        <div class="sidebar-brand">
            <div class="brand-badge">
                ...
                <span class="brand-name">DCLIC</span>
            </div>
        ...
        <div class="sidebar-foot">
            <div class="librarian-card">
                ...
                <div>
                    <div class="librarian-name">James Brian</div>
    ...
    <main class="main">
        <div class="topbar">
            <div class="topbar-left">
                ...
                <p>@yield('page-sub', 'Davao City Library and Information Center')</p>
            </div>
